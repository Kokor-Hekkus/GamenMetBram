...
namespace ProjectMarc
{
    public class InventorySlot : ItemSlotUI, IDropHandler
    {
        ...
        public ItemSlot ItemSlot => inventory.ItemContainer.GetSlotByIndex(SlotIndex); //when referring to itemslot here it gets the correct item and not the whole array
        ...
        public override void OnDrop(PointerEventData eventData)
        {
            ...
            {
                inventory.ItemContainer.Swap(itemDragHandler.ItemSlotUI.SlotIndex, SlotIndex); //swap index with current index
            }
        }
